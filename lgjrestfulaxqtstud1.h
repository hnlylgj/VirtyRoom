...
/////////////////////////////////////////////////////////////////////////////
// CLgjrestfulaxqtstud1 包装器类

class CLgjrestfulaxqtstud1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CLgjrestfulaxqtstud1)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0x369715E2, 0x6627, 0x4369, { 0x9C, 0x7D, 0xE0, 0x15, 0x53, 0x88, 0xC6, 0xC3 } };
		return clsid;
	}
...
//
	...
	void CopyParaTo(LPCTSTR p_UserID, LPCTSTR p_UserSig, LPCTSTR p_UserToken)
	{
		...
		InvokeHelper(0x38, DISPATCH_METHOD, VT_EMPTY, NULL, parms, p_UserID, p_UserSig, p_UserToken);
	}
	void SlaverJoinRoom(long p_mUserType, LPCTSTR p_RoomID)
	{
		static BYTE parms[] = VTS_I4 VTS_BSTR ;
		InvokeHelper(0x39, DISPATCH_METHOD, VT_EMPTY, NULL, parms, p_mUserType, p_RoomID);
	}
	void SlaverKeepLive()
	{
	...
	void GetRooomList(long p_flag, long p_page, long p_count)
	{
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x3c, DISPATCH_METHOD, VT_EMPTY, NULL, parms, p_flag, p_page, p_count);
	}
